...
public class FailedEditText extends EditText implements View.OnKeyListener {
    ...
    public FailedEditText(Context context) {
        super(context);
    ...
    public FailedEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.d("Constructor", "word");
        setOnKeyListener(this);
        addTextChangedListener(mListener);
    ...
    public FailedEditText(Context context, AttributeSet attrs, int defStyleAttr) {
